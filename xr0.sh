...
menu() {
	...
	echo -e "# ${GREEN}Telegram 群组${PLAIN}: https://https://t.me/vpsjiaoliudajian                                         # "
	echo -e "# ${GREEN}YouTube 频道${PLAIN}: https://www.youtube.com/channel/UCmteg7BSPK8pTFvKAlkBoEw                       #"
	echo "################################################################################################"
	echo -e "  "
	...
	echo " -------------"
	echo -e "  ${GREEN}18.${PLAIN}  VPS系统优化"
	echo -e "  ${GREEN}19.${PLAIN}  放开VPS的所有端口"
	echo -e "  ${GREEN}20.${PLAIN}  开启IPv6"
	echo -e "  ${GREEN}21.${PLAIN}  禁用IPv6"
	echo " -------------"
